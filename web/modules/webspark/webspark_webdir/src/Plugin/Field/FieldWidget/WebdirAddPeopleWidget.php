 ...
 *
 * @FieldWidget(
 *   id = "field_webdir_add_people_widget",
 *   module = "webspark_webdir",
 *   label = @Translation("Webdir add people by department"),
 *   field_types = {
 *     "string"
 *   }
 * )
 */
class WebdirAddPeopleWidget extends WidgetBase {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    $element['#attached']['library'][] = 'webspark_webdir/add_people_field';
